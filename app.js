...
const REFRESH_TOKEN_SECRET = "Ex5D5VLa1CIVCuNbweU66aT5GnT4c2O1hYPHriwMTp7eciEcnRq3QNwvfwTfEhzt76BRcZtX7IrIVHxY"
    ...
    try{
        ...
        if(currentUser){
            ...
            if(correctPassword){
                ...
                res.json({ accessToken: accessToken, refreshToken: refreshToken, email:email, name:currentUser.name,isAdmin:currentUser.isAdmin  })
